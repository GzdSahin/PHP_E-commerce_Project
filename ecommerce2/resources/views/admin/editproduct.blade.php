...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sayfa/</span> Ürün Düzenle</h4>
 ...
 <div class="col-xxl">
   <div class="card mb-4">
     <div class="card-header d-flex align-items-center justify-content-between">
       <h5 class="mb-0"> Ürün Güncelle</h5>
       ...
       <form action="{{route('updateproduct')}}" method="post"  >
        ...
        <input type="hidden"  value="{{$productinfo->id}}"  name="id">
         ...
         <div class="row mb-3">
           ...
           <div class="col-sm-10">
             <input type="text" class="form-control" id="quantity" name="quantity" placeholder="100"   value="{{$productinfo->quantity}}"/>
           </div>
         </div>
