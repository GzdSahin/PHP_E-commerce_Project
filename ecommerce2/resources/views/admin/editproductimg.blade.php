   ...
   <div class="card mb-4">
     ...
     <div class="card-body">
       <form action="{{route('updateproductimg')}}" method="post"  enctype="multipart/form-data">
        @csrf
         <div class="row mb-3">
           <label class="col-sm-2 col-form-label" for="basic-default-name">Ürün Resmi:</label>
           <div class="col-sm-10">
         ...
         <div class="row mb-3">
           <label class="col-sm-2 col-form-label" for="basic-default-name">Yüklenecek Yeni Resim:</label>
           <div class="col-sm-10">
