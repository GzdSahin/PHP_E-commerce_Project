      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sayfa/</span> Tüm Alt Kategoriler</h4>
               <!-- Contextual Classes -->
...
@endif
              ...
              <div class="card">
                <h5 class="card-header">Mevcut AltKategori Bilgileri</h5>
                  ...
                  <table class="table">
                    ...
                    @foreach ($allsubcategories as $subcategory )
                      ...
                      <tr>
                        ...
                        <a href="{{route('deletesubcat',$subcategory->id)}}" class="btn btn-warning">SİL</a>
