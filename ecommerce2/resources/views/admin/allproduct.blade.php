      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="container">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sayfa/</span> Tüm Ürünler</h4>
               <!-- Contextual Classes -->
...
@endif
              ...
              <div class="card">
                <h5 class="card-header">Mevcut Ürün Bilgileri</h5>
                    ...
                    <tbody class="table-border-bottom-0">
                      @foreach ( $products as $product )
                        ...
                        <td><img  style="height:100px;" src="{{asset($product->product_img)}}" alt="">
                           <br><br>
                           <a href="{{route('editproductimg',$product->id)}}" class="btn btn-primary">Resmi Güncelle</a>
                      </td>
                        <td>{{$product->price}}</td>
                        <td>

                        <a href="{{route('editproduct',$product->id)}}" class="btn btn-primary">DÜZENLE</a>
                        <a href="{{route('deleteproduct',$product->id)}}" class="btn btn-warning">SİL</a>
