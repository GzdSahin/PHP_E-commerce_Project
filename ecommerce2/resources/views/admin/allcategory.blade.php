      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
              ...
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sayfa/</span> Tüm Kategoriler</h4>
               <!-- Contextual Classes -->

              <div class="card">
                <h5 class="card-header">Mevcut Kategori Bilgileri</h5>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <a href="{{route('deletecategory',$category->id)}}" class="btn btn-warning">SİL</a>
