...
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Sayfa/</span> AltKategori Ekle</h4>
   ...
   <div class="card mb-4">
     ...
     <div class="card-body">
       <form action="{{route('storesubcategory')}}" method="post">
        @csrf
         <div class="row mb-3">
           <label class="col-sm-2 col-form-label" for="basic-default-name">Alt Kategori İsmi</label>
           <div class="col-sm-10">
             <input type="text" class="form-control" id="subcategory_name" name="subcategory_name" placeholder="elektronik" />
           </div>
         </div>
         <div class="row mb-3">
