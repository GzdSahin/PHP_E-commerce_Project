   ...
   <body >
      ...
      <div class="banner_bg_center">
           ...
           <div class="container">
               <div class="row">
                  ...
                  <div class="colg-4">
                      ...
                      <div class="tshirt_img" style="height: 250px; width: 250px;"><img src="{{ asset($proc->product_img) }}"></div>
                ...
                <div class="box_main">
                  <div class="product-info">  
                         ...
                         <h4 class="product_text text-left" > {{$proc->product_name}}</h4>
                      <p class="price_text text-left">Fiyat : <span style="color: #262626;">{{$proc->price}} ₺</span></p>
                     </div>
                     
                      <div class="my-3 product-details">
                           
                      <p class="lead"> {{$proc->product_long_des}}</p>
                      <ul class="p-2 bg-light my-2">
                        <li>Category:   {{$proc->product_category_name}}</li>
                        <li>Mevcut Stok adedi:   {{$proc->quantity}}</li>
                      ...
                      <div class="btn_main">
                       ...
                       <input type="hidden"  value="{{$proc->id}} "  name="product_id" >
                       <input type="hidden"  value="{{$proc->price}} "  name="price" >
                       ...
                       <br>
                        ...
                        <div class="form-group">
                           ...
                           <input type="submit"class="btn btn-warning" value="SEPETE EKLE">
         ...
         <div id="main_slider" >
                  ...
                  <div class="container">
                     <h1 class="fashion_taital">İLGİLİ ÜRÜNLER</h1>
                        ...
                        @foreach ( $related_products as $product)
                              ...
                              <div class="col-lg-4 col-sm-4">
                                 <div class="box_main">
                                    ...
                                    <div class="btn_main">
                                       <div class="buy_bt"><a href="#">SATIN AL</a></div>
                                       <div class="seemore_bt"><a href="{{route('singleproduct',[$product->id,$product->slug])}}">DAHA FAZLA</a></div>
                                    </div>
                                 </div>
                              </div>
                               @endforeach
