...
<html lang="en">
   ...
   <body >
      ...
      <div class="banner_bg_center">
         ...
         <br><br>
           <div class="container">
                <h3>Siparişinizi Vermek İçin Son Adım</h3>
                ...
                <div class="row">
                 ...
                 <div class="col-6">
                      <div  class="box-main">
                           ...
                           <p style="background-color: green; color:white; height: 50px; text-align:center; "> SİPARİŞ BİLGİLERİ</p>
                        
                       
                           <p style="background-color: white;"> Adres: {{ $shipping_adress->city_name }}
                        <br><br> Posta Kodu: {{ $shipping_adress->postal_code }} <br><br>Telefon Numarası:  {{ $shipping_adress->phone_number }}</p>
                  ...
                  <div  class="box-main">
                    ...
                    @endforeach
                     ...
                     <tr>
                        ...
                        <td></td>
                        <td></td>
                        <td class="fw-bold">Toplam Tutar :</td>
                        <td >{{$total}} ₺</td>
                        

                         @if($total<=0)
                         <td> <a href="" class="btn btn-primary disabled">ÖDEME YAP</a> </td>
                         @else
            ...
            @csrf
             <input type="submit" style="height: 50px;" value="Sipariş Ver"  class="btn btn-primary" >
            ...
            @csrf
            <input type="submit" style="height: 50px;" value="İptal Et" class="btn btn-danger" mr-3>
