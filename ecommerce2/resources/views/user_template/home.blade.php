         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <div class="dropdown">
                     <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tüm Kategoriler 
                     </button>
               ...
               <div id="my_slider" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Yaşam Alanınızı <br>Güzelleştirin !</h1>
                              <div class="buynow_bt"><a href="#">Alışverişe Başla</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Hayalindeki Yaşam Alanını <br>Tasarla!</h1>
                              <div class="buynow_bt"><a href="#">Alışverişe Başla</a></div>
                           </div>
                        </div>
                     </div>
                     <div class="carousel-item">
                        <div class="row">
                           <div class="col-sm-12">
                              <h1 class="banner_taital">Eviniz İçin İpuçları <br>İlham Veren Fikirler!</h1>
                              <div class="buynow_bt"><a href="#">Alışverişe Başla</a></div>
                           </div>
                        </div>
                     </div>
